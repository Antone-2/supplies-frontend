...
// Test Pesapal checkout session creation without notification_id field
async function testPesapalCheckout() {
    console.log('🔍 Testing Pesapal checkout session creation (notification_id omitted)...\n');
    ...
    try {
        ...
        // Test checkout session creation without notification_id field
        ...
        const pesapalOrder = {
            ...
            // notification_id field is completely omitted
            billing_address: {
