...
// Test Pesapal checkout session creation with notification_id = "0"
async function testPesapalCheckout() {
    console.log('🔍 Testing Pesapal checkout session creation (notification_id = "0")...\n');
    ...
    try {
        ...
        // Test checkout session creation with notification_id = "0"
        ...
        const pesapalOrder = {
            ...
            notification_id: '0', // Default IPN ID for sandbox
            billing_address: {
        ...
        console.log('5. Contact Pesapal support for sandbox IPN ID requirements');
    }
}
