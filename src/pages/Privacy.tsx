      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-2">
            <Card>
              <CardHeader>
                <CardTitle className="font-semibold">1. Information We Collect</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-semibold">2. How We Use Your Information</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3 text-sm">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-semibold">3. Information Sharing</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3 text-sm">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-semibold">4. Data Security</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3 text-sm">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-semibold">5. Cookies and Tracking</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3 text-sm">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-semibold">6. Your Rights</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3 text-sm">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-semibold">7. Data Retention</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-semibold">8. International Transfers</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-semibold">9. Children's Privacy</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-semibold">10. Contact Us</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-sm">
                  <p>If you have questions about this Privacy Policy or our data practices, contact us:</p>
                  <div className="mt-3 space-y-1">
                    <p><strong>Email:</strong> {import.meta.env.VITE_PRIVACY_EMAIL || 'privacy@medhelmsupplies.co.ke'}</p>
