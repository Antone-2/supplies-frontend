...
const ReviewsPage = () => {
    ...
    return (
        <div className="min-h-screen">
            <main className="container mx-auto px-4 py-12 max-w-full sm:max-w-md md:max-w-4xl">
                {/* Header */}
                <div className="text-center mb-12">
                    <h1 className="text-3xl md:text-4xl font-bold mb-4 text-medical-heading font-['Roboto']">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {reviews.map((review) => (
                        <Card key={review.id} className="hover:shadow-md transition-shadow w-full max-w-sm mx-auto md:max-w-none">
