...
const Returns = () => {
  ...
  const handleEmailSupport = () => {
    window.location.href = `mailto:${import.meta.env.VITE_RETURNS_EMAIL || 'returns@medhelmsupplies.co.ke'}`;
  };
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Call us at {import.meta.env.VITE_SUPPORT_PHONE || '+254 746 020 323'} or email {import.meta.env.VITE_RETURNS_EMAIL || 'returns@medhelmsupplies.co.ke'} within 30 days of purchase.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex flex-col gap-4">
                  ...
                  >
                    Email: {import.meta.env.VITE_RETURNS_EMAIL || 'returns@medhelmsupplies.co.ke'}
                  </Button>
                </div>
              </CardContent>
            </Card>
