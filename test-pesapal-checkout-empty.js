...
// Test Pesapal checkout session creation with empty notification_id
async function testPesapalCheckout() {
    console.log('🔍 Testing Pesapal checkout session creation (notification_id = "")...\n');
    ...
    try {
        ...
        // Test checkout session creation with empty notification_id
